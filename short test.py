...
def services():
        ...
        def transfer():
            ...
            if(rl==[]):
                ...
                with smtplib.SMTP('smtp.gmail.com', 587) as smtp:
                    ...
                    smtp.sendmail('otplogin123@gmail.com', frm, msg)
                ...
                with smtplib.SMTP('smtp.gmail.com', 587) as smtp:
                    ...
                    body = 'RECIEVED'
                    msg = f'Subject: {subject}\n\n{body}'
                    smtp.sendmail('otplogin123@gmail.com', to, msg)
    ...
    def account_details():
        ...
        ld_accno2 = Label(l_3,text=nl[0][8],font=("Helvetica",20),bg="light grey")
       ...
       if(int(e_otp.get())==otp):
           ...
           def create_data():
               if(e_password.get()==e_cpassword.get()):
                   ...
                   wpass.destroy()
                   win.destroy()
                   accn = random.randrange(10000000,11000001)
